...
def extraerEspectador(file):
    ...
    for articles in soup.find_all('div',class_='Card-Container'):
      ...
      titulo_link = articles.find_all('h2',class_='Card-Title Title Title')
      try:
        titulo_link = articles.find_all('h2',class_='Card-Title Title Title_main')
    ...
    for i in range(0,10):
      texto+='"'+categorias[i]+'",'+'"'+titulos[i]+'",'+'"'+links[i]+'"'+"\n"
